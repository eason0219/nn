...
cc -g -Wall -Werror -c src/layer.c -o build/layer.o

cc -g -Wall -Werror -c src/neuron.c -o build/neuron.o

cc -pthread -lpthread -o backprop build/main.o build/layer.o build/neuron.o -lm -o bin/backdrop
